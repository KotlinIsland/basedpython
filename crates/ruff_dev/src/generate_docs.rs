    ...
    for rule in Rule::iter() {
        if let Some(explanation) = rule.explanation() {
            ...
            let _ = writeln!(
                ...
                r#"<small>
{status_text} ·
<a href="{repository}/issues?q=sort%3Aupdated-desc%20is%3Aissue%20is%3Aopen%20{issue_search}" target="_blank">Related issues</a> ·
