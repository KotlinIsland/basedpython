...
impl ClassIr {
    ...
    /// left under it
    fn rebinds(&self, method: &Function) -> bool {
...
impl ModuleIr {
    ...
    fn built_through_its_metaclass(&self, class: &ClassIr) -> bool {
    ...
    ///
    /// a property half of a class built through its metaclass
    /// (`Self::built_through_its_metaclass`) is one too. such a class is handed the
