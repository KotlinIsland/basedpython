...
impl AutogenKind {
    const fn filename(self) -> &'static str {
        match self {
            AutogenKind::Py => "mdtest_snippet.py",
            AutogenKind::Pyi => "mdtest_snippet.pyi",
            AutogenKind::Ipynb => "mdtest_snippet.ipynb",
            AutogenKind::By => "mdtest_snippet.by",
            AutogenKind::Byi => "mdtest_snippet.byi",
        }
    }
}
...
impl EmbeddedFilePath<'_> {
    fn as_str(&self) -> &str {
        match self {
            EmbeddedFilePath::Autogenerated(kind) => kind.filename(),
...
impl EmbeddedFile<'_> {
    ...
    fn is_checkable(&self) -> bool {
        matches!(
            self.lang,
            "py" | "python" | "pyi" | "ipynb" | "toml" | "by" | "byi" | "bython" | "basedpython"
        )
    }
}
    ...
    F: FnMut(&C) -> anyhow::Result<()>,
{
    ...
    fn process_code_block(
        ...
        if let Some(explicit_path) = self.explicit_path {
            let expected_extension = match lang {
                "python" => "py",
                "bython" | "basedpython" => "by",
                other => other,
            };
        ...
        let path = match self.explicit_path {
            ...
            None => match lang {
                "py" | "python" => EmbeddedFilePath::Autogenerated(AutogenKind::Py),
                "pyi" => EmbeddedFilePath::Autogenerated(AutogenKind::Pyi),
                "ipynb" => EmbeddedFilePath::Autogenerated(AutogenKind::Ipynb),
                "by" | "bython" | "basedpython" => EmbeddedFilePath::Autogenerated(AutogenKind::By),
                "byi" => EmbeddedFilePath::Autogenerated(AutogenKind::Byi),
                "" => {
                    bail!(
...
mod tests {
    ...
    use crate::parser::{AutogenKind, EmbeddedFilePath};
    ...
    fn single_file_test() {
        ...
        assert_eq!(file.path, EmbeddedFilePath::Autogenerated(AutogenKind::Py));
    ...
    fn notebook_test() {
        ...
        assert_eq!(
            file.path,
            EmbeddedFilePath::Autogenerated(AutogenKind::Ipynb)
        );
