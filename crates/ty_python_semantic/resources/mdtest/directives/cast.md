...
info[disjoint-cast]: Cast to a disjoint type
   ...
   5 |     cast(list[int], values)
     ...
     |
    ::: stdlib/builtins.byi:2647:7
     |
2647 | class list[in out Element](MutableSequence[Element]):
     |       ---- `list` defined here
...
info[disjoint-cast]: Cast to a disjoint type
   ...
   5 |     cast(tuple[int, int], value)
     ...
     |          Disjoint from the inferred type
     |
    ::: stdlib/builtins.byi:2586:7
     |
2586 | class tuple[out Element](Sequence[Element]):
     |       ----- `tuple` defined here
