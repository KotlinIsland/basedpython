...
def bounded_invariant(
    ...
    reveal_type(top.put)  # revealed: bound method Top[BoundedInvariant[Any]].put(value: Never)
    ...
    reveal_type(bottom.put)  # revealed: bound method Bottom[BoundedInvariant[Any]].put(value: int)
...
def constrained_invariant(
    ...
    reveal_type(top.put)  # revealed: bound method Top[ConstrainedInvariant[Any]].put(value: Never)

    reveal_type(bottom.unrelated)  # revealed: Any
    reveal_type(bottom.get)  # revealed: bound method Bottom[ConstrainedInvariant[Any]].get() -> Never
    reveal_type(bottom.put)  # revealed: bound method Bottom[ConstrainedInvariant[Any]].put(value: int | str)
    reveal_type(bottom.value)  # revealed: Never
```
...
def constructor(top: Top[ProtocolWithInit]) -> None:
    reveal_type(top.__init__)  # revealed: bound method Top[ProtocolWithInit].__init__(value: int)
```
...
reveal_type(accepts_legacy)  # revealed: def accepts_legacy[T](value: Top[LegacyProtocol[T]])
```
