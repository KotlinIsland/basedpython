...
pub(crate) use self::static_literal::{
    ...
    based_enum_has_payload_variants, based_enum_is_idiomatic, based_enum_of_variant,
    based_enum_unit_member_names, based_enum_unit_variant_class, based_enum_variant_union,
