...
impl KnownComparisonSemantics {
    ...
    fn of_literal<'db>(
        ...
        match literal {
            ...
            // basedpython float/complex literals: their equality crosses numeric
            // types and NaN breaks reflexivity, so no builtin comparison shape
            // is claimed
            LiteralValueTypeKind::Float(_) | LiteralValueTypeKind::Complex(_) => None,
        }
    }
