...
impl Held {
    ...
    #[cfg(test)]
    pub(crate) fn at_entry(function: &Function) -> Self {
    ...
    pub(crate) fn exact_kind(&self, function: &Function, value: &Value) -> Option<Kind> {
        match value {
    ...
    pub(crate) fn release_is_inert(&self, function: &Function, register: RegisterId) -> bool {
        function
            .register(register)
