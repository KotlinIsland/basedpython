...
</dd><dt id="by-build--no-checked-cast"><a href="#by-build--no-checked-cast"><code>--no-checked-cast</code></a></dt><dd><p>lower <code>&lt;value&gt; cast &lt;type&gt;</code> to an unchecked <code>typing.cast</code> instead of a runtime-checked cast that raises on a type mismatch (the <code>cast?</code> safe form is unaffected)</p>
...
</dd><dt id="by-transpile--no-checked-cast"><a href="#by-transpile--no-checked-cast"><code>--no-checked-cast</code></a></dt><dd><p>lower <code>&lt;value&gt; cast &lt;type&gt;</code> to an unchecked <code>typing.cast</code> instead of a runtime-checked cast that raises on a type mismatch (the <code>cast?</code> safe form is unaffected)</p>
