...
</dd><dt id="by-build--out"><a href="#by-build--out"><code>--out</code></a>, <code>-o</code> <i>dir</i></dt><dd><p>Where to write the output [default: <code>build</code>, or <code>dist</code> with <code>--wheels</code>]</p>
...
</dd><dt id="by-compile--out"><a href="#by-compile--out"><code>--out</code></a>, <code>--output</code>, <code>-o</code> <i>dir</i></dt><dd><p>Where to write the generated C and the extension modules.</p>
...
<p>[default: build]</p></dd><dt id="by-compile--require-native"><a href="#by-compile--require-native"><code>--require-native</code></a></dt><dd><p>Fail the build if <em>any</em> function is left to its interpreted definition, whatever the reason.</p>
