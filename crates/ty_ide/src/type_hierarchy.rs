...
mod tests {
    ...
    fn supertypes_implicit_object() {
        ...
        insta::assert_snapshot!(
            ...
            @"vendored://stdlib/builtins.byi:2290:2296 object :: builtins",
        );
    }
    ...
    fn subtypes_str_conditional_no_duplicates() {
        ...
        vendored://stdlib/enum.byi:17985:17992 StrEnum :: enum
        vendored://stdlib/pdb.byi:38332:38337 _rstr :: pdb
    ...
    fn dynamic_class_prepare_and_supertypes_inline() {
        ...
        insta::assert_snapshot!(
            ...
            @"vendored://stdlib/builtins.byi:7018:7022 type :: builtins",
        );
        let supertypes = test.supertypes();
        insta::assert_snapshot!(
            snapshot(&test.db, &supertypes),
    ...
    fn namedtuple_prepare_and_supertypes_variable_definition() {
        ...
        insta::assert_snapshot!(
            snapshot(&test.db, &supertypes),
            @"vendored://stdlib/builtins.byi:97528:97533 tuple :: builtins",
        );
    }
