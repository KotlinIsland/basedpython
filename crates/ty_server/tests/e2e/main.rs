...
impl TestServer {
    ...
    pub(crate) fn open_text_document_as(
        ...
        self.open_text_document_with_uri(self.file_uri(path), content, version, language_id);
    }
    ...
    pub(crate) fn open_virtual_text_document(
        ...
        self.open_text_document_with_uri(uri, content, version, LanguageKind::Python);
        Ok(())
    }

    fn open_text_document_with_uri(
        &mut self,
        uri: Uri,
        content: impl AsRef<str>,
        version: i32,
