...
impl InlayHintOptions {
    fn into_settings(self) -> InlayHintSettings {
        InlayHintSettings {
            ...
            inferred_reification: self.inferred_reification.unwrap_or(true),
            ...
            inferred_reads: self.inferred_reads.unwrap_or(true),
            parameter_stability: self.parameter_stability.unwrap_or(true),
            derived_dependencies: self.derived_dependencies.unwrap_or(true),
            inferred_invalidations: self.inferred_invalidations.unwrap_or(true),
            ...
            implicit_self: self.implicit_self.unwrap_or(true),
            ...
            inherited_parameter_defaults: self.inherited_parameter_defaults.unwrap_or(true),
            inferred_return_types: self.inferred_return_types.unwrap_or(true),
            property_types: self.property_types.unwrap_or(true),
